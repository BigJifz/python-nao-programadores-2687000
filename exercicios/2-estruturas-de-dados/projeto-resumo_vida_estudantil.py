...
cursos = input('Qual os cursos que você já fez pelo LinkedIn Learning? (separe-os com vírgula)')
...
print(f"Olá {estudante['nome']}, desde {estudante['ano_conheceu_LinkedIn']} você conhece o LinkedIn. Nesses {total_anos} anos, você realizou {total_cursos} cursos, sendo o primeiro curso {estudante['cursos'][0]}")