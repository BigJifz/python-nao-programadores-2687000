...
total_horas = input('Quantas horas você estuda por dia aproximadamente?')

# 4. Crie uma variável chamada "curso" e, usando o método input(), solicite o título do curso desejado;

curso = input('Qual curso você está fazendo atualmente?')
...
print(f'Olá {nome}, você costuma estudar {total_dias} dias por semana, durante mais ou menos {total_horas} horas diárias. Isso sigifica que você estuda em média {total_dias*total_horas} horas por semana, para o curso de {curso}.')